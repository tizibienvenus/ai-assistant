...
import com.inov.assistant.service.DocumentationGuideService;
...
public class OpenApiConfig implements WebMvcConfigurer{ 
        ...
        public OpenAPI documentationAggregatorOpenApi(
                ...
                return new OpenAPI()
                        .info(new Info()
                                .title("Inov Consulting AI Assistant API - Documentation")
                                .version("1.0")
                                ...
                                .termsOfService("https://inov-consulting.com/terms"))
                        .servers(List.of(
                                new Server()
                                ...
                                new Server()
                                        ...
                                        .url("https://api.inov-consulting.com")
                        ));
        }
        ...
        registry.addResourceHandler("/scalar/**")
                .addResourceLocations("classpath:/static/scalar/");
        ...
        public void addViewControllers(ViewControllerRegistry registry) {
                ...
                registry.addViewController("/documentation/scalar")
                         .setViewName("forward:/scalar/index.html");
        }
}
